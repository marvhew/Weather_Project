...
public class JSONParser {
	...
	private static DayForecast ParseDay(JSONObject object) {
		...
		forecast = new DayForecast(ParseTemperature(object.optJSONObject("temp")),ParseWeather(object.optJSONArray("weather")),new Date(object.optLong("dt")*1000),object.optDouble("pressure"),object.optDouble("speed"),object.optDouble("rain"),object.optDouble("snow"),object.optInt("humidity"),object.optInt("deg"),object.optInt("clouds"));
