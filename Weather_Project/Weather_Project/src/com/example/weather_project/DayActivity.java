...
public class DayActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		editingView.setText(forecast.getPressureAsString()+"hPa");
		editingView = (TextView) findViewById(R.id.Txt_TemperatureMin);
		editingView.setText(forecast.getTemperatureMinAsString()+"°C");
		editingView = (TextView) findViewById(R.id.Txt_TemperatureMax);
		editingView.setText(forecast.getTemperatureMaxAsString()+"°C");
		editingView = (TextView) findViewById(R.id.Txt_TemperatureMorn);
		editingView.setText(forecast.getTemperatureMornAsString()+"°C");
		editingView = (TextView) findViewById(R.id.Txt_TemperatureEve);
		editingView.setText(forecast.getTemperatureEveAsString()+"°C");
